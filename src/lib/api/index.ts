...
export type { DetailedBookableItemCategoryDto } from './models/DetailedBookableItemCategoryDto';
export type { DetailedBookableItemDto } from './models/DetailedBookableItemDto';
