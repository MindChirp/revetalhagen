      ...
      <Card className="mx-auto md:w-fit w-full md:min-w-[700px]">
        ...
        <CardContent>
          <div className="w-full flex gap-5 items-center justify-center flex-col">
            ...
            <Typography variant="p" className="md:max-w-[600px] w-fit md:mx-20">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Neque in
              impedit aliquam magnam cumque vitae magni a commodi voluptatem.
              Numquam tenetur minima ex quod similique fuga dignissimos vero sed
              officiis. Lorem ipsum, dolor sit amet consectetur adipisicing
              elit. Neque in impedit aliquam magnam cumque vitae magni a commodi
              voluptatem. Numquam tenetur minima ex quod similique fuga
              dignissimos vero sed officiis.
            </Typography>
          </div>
        </CardContent>
      </Card>
